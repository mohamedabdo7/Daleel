...
// const FounderSection: React.FC = () => {
//   return (
//     <section className="w-full bg-white px-6 md:px-16 lg:px-20 xl:px-24">
//       <SectionHeader
//         primaryText="DaleelFM"
//         secondaryText="Founder"
...
//             {/* Founder Image with Circle BG */}
//             <div className="flex-shrink-0 relative flex items-center justify-center w-32 h-32 md:w-36 md:h-36 lg:w-40 lg:h-40">
//               <span className="absolute w-32 h-32 md:w-36 md:h-36 lg:w-48 lg:h-48 rounded-full bg-[#B5E2DD] left-0 right-10 top-3 md:top-4 lg:top-8 z-0" />
//               <Image
//                 src="/images/founder.png"
//                 alt="Dr. Hadi Alenazy"
//                 width={360}
//                 height={480}
//                 className="w-[180px]  md:w-32 lg:w-36 h-[260px] object-cover z-10 relative"
//                 priority
//               />
//             </div>

//             {/* Founder Info */}
//             <div className="flex-1 flex flex-col items-start justify-start lg:pl-4">
//               <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-primary mb-3 md:mb-4 leading-tight text-left">
//                 Dr. Hadi Alenazy
//               </h2>
//               <div className="text-secondary text-sm md:text-base font-medium leading-relaxed text-left space-y-3 md:space-y-4">
//                 <p>
//                   <span className="font-semibold">
...
//                     </a>
//                   </span>{" "}
//                   and is currently Executive Director, Planning and Quality at
//                   Health and Life Sector, Tawuniya.
//                 </p>

//                 <p>
//                   Dr. Hadi Saeed Alenazy, is hugely experienced Consultant of
//                   Family Medicine, Medical Education and Healthcare Quality and
//                   Patient Safety.
//                 </p>

//                 <p>
//                   His breadth of knowledge of the healthcare sector has led to
//                   his being appointed in numerous national roles supporting the
//                   Kingdom's healthcare transformation including Deputy-Chair and
//                   Member of the Family Medicine Scientific Council, SCFHS, and
//                   Board Member and Head of Scientific Committee, SSFCM.
//                 </p>
//               </div>
//             </div>
//           </div>
