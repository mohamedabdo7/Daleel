...
const Navbar = () => {
  ...
  const handleLogout = () => {
    ...
    router.push(getLocalizedRoute(ROUTES.HOME));
  };
              ...
              {isAuthenticated && user ? (
                ...
                >
                  <motion.button
                    ...
                    className="flex items-center space-x-2.5 px-3 py-2 rounded-xl bg-white/80 backdrop-blur-sm border border-slate-200/60 hover:bg-white hover:border-slate-300/60 hover:shadow-sm transition-all duration-200 group"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                  >
                    {/* User Avatar */}
                    <div className="relative">
                      <div className="w-7 h-7 bg-gradient-to-br from-slate-800 to-slate-600 rounded-full flex items-center justify-center text-white text-xs font-medium">
                    ...
                    {/* User Name */}
                    <span className="text-sm font-medium text-slate-700 group-hover:text-slate-900 transition-colors duration-200 max-w-24 truncate">
                      {user.name?.split(" ")[0]}
                    </span>

                    {/* Dropdown Arrow */}
                    <motion.svg
                      className="w-4 h-4 text-slate-400 group-hover:text-slate-600 flex-shrink-0"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    ...
                    {isUserDropdownOpen && (
                      <>
                        ...
                        <motion.div
                          ...
                          className="absolute top-full right-0 mt-2 w-64 bg-white/95 backdrop-blur-xl rounded-xl shadow-lg border border-white/20 overflow-hidden z-20 ring-1 ring-black/5"
                        >
                          {/* Modern Menu Items */}
                          <div className="p-1">
                            {/* User Info */}
                            <div className="px-3 py-3 mb-1">
                              <div className="flex items-center space-x-3">
                                <div className="w-9 h-9 bg-gradient-to-br from-slate-800 to-slate-600 rounded-full flex items-center justify-center text-white text-sm font-medium ring-2 ring-white/10">
                                  {getUserInitials(user.name || "User")}
                                </div>
                            ...
                            <div className="h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent mb-1"></div>
                            ...
                            <motion.button
                              ...
                              className="w-full flex items-center space-x-3 px-3 py-2.5 text-slate-700 hover:bg-slate-50 rounded-lg transition-all duration-200 group"
                              whileHover={{ scale: 1.02 }}
                              whileTap={{ scale: 0.98 }}
                            >
                              <div className="w-8 h-8 bg-slate-100 rounded-lg flex items-center justify-center group-hover:bg-slate-200 transition-colors duration-200">
                                <svg
                            ...
                            <motion.button
                              ...
                              className="w-full flex items-center space-x-3 px-3 py-2.5 text-slate-700 hover:bg-red-50 hover:text-red-700 rounded-lg transition-all duration-200 group"
                              whileHover={{ scale: 1.02 }}
                              whileTap={{ scale: 0.98 }}
                            >
                              <div className="w-8 h-8 bg-slate-100 rounded-lg flex items-center justify-center group-hover:bg-red-100 transition-colors duration-200">
                                <svg
                                  className="w-4 h-4 text-slate-600 group-hover:text-red-600"
                                  fill="none"
                                  stroke="currentColor"
                                  viewBox="0 0 24 24"
                                >
                ...
                <>
                  ...
                  >
                    <Button variant="default" size="md" className="w-[150px]">
                      <Link href={getLocalizedRoute("/login")}>Login</Link>
                    </Button>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, x: 20 }}
                  ...
                  >
                    <Button variant="secondary" size="md" className="w-[150px]">
                      <Link href={getLocalizedRoute("/signup")}>Sign up</Link>
                    </Button>
                  </motion.div>
                </>
              )}
