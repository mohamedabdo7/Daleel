...
import LecturesLoading from "./components/LecturesLoading";
import EmptyState from "./components/EmptyState";
import { getLectures, Lecture } from "@/lib/api/lectures.service";
...
export default function LecturesPage() {
  ...
  const { data, isLoading, isError, error } = useQuery<
    LaravelListResponse<Lecture>,
    Error
  >({
    queryKey: qk.lectures.list(queryParams),
    queryFn: ({ signal }) =>
      getLectures(queryParams, signal) as Promise<LaravelListResponse<Lecture>>,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      ...
      <PageHeader
        ...
        description="Discover the latest medical education and insights"
        iconAlt="Lectures Icon"
        showSearch={true}
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <AnimatePresence mode="wait">
            ...
            >
              <Alert className="max-w-md border-destructive/20 bg-destructive/5">
                ...
                <AlertDescription className="text-destructive">
                  <div className="font-medium">Failed to load lectures</div>
          ...
          {!isLoading && !isError && items.length === 0 && (
            ...
            >
              <EmptyState searchKeyword={keyword} />
            </motion.div>
          )}
